...
| **TOTAL**               |  2993 | 2993 |    2993 |         2993 |         2993 |       2993 |      2993 |   2993 |  1588 |            2554 |     183840 |        61.42 |     —     |     —     |     —     |   —   | <span style="white-space: nowrap;">18/27 Ready</span>                                                                                                                                                                           |

## Current Snapshot Summary

- 27 adapters audited.
- All 27 adapters are at full required-core parity for the current captured files.
- Combined-ready adapters (Ready = ✅): 18 / 27.
- Rates coverage signal: 1588 / 2993 files currently include normalized_rates.days.
- Pricing-records coverage signal: 2554 / 2993 files currently have per-listing pricing JSON records.
- API capability signal:
  - Availability API present: 13 / 27 adapters.
  - Rates API present: 6 / 27 adapters.
  - Pre-reservation API present: 13 / 27 adapters.
...
- Remaining adapters failing quote pricing validation (`npm run pricing:validate:quotes:all`):
  - `30aescapes`: `validated=169 failed=4`
  - `beachblue`: `validated=16 failed=1`
- Next remediation target order: `30aescapes`, then `beachblue`.
