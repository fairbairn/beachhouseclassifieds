...
Last updated: 2026-04-04T23:40:00Z
...
| realjoy30a              | track_bluetent  | yes              | no                      | quote_window_avg  | template_url    | ready       | [x]     | quote sidecars + handoff validation are in place and pricing record parity is confirmed on disk (140/140, excluding `details/pricing/index.json`); continue monitoring occasional upstream latency                          |
...
| sandersbeach30a         | streamline      | yes              | no                      | quote_window_avg  | template_url    | ready       | [x]     | full quote + pricing runtime pass complete (74/74), quote validator passing (74/74), and handoff alignment validation passing                                                                                               |
