...
type Blue360DetailRecord = DetailRecordBase & {
  title: string;
  h1: string;
...
async function fetchDetail(
...
): Promise<Blue360DetailRecord | null> {
  ...
  try {
    ...
    const normalizedAvailability: Blue360DetailRecord["normalized_availability"] =
      {
        source: "pm_360blue",
...
export function createBlue360Adapter(): ScraperAdapter<Blue360DetailRecord> {
  return {
    managerKey: "360blue",
    scriptLabel: "360blue",
